...
class AllGamesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: const Color.fromRGBO(13, 30, 43, 1), // Warna latar belakang
        child: Padding(
            ...
            itemBuilder: (context, index) {
              return Card(
                ...
                child: ListTile(
                  leading: ClipOval(
                    child: Image.network(
                      games[index].imageUrl, // URL gambar game
                  ...
                  title: Text(
                    games[index].name, // Nama game
                    style: const TextStyle(color: Colors.black), // Warna teks
                  ),
                  onTap: () {
                    // Navigasi ke halaman ProductDetailView
